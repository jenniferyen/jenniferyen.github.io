...
function Bio(props) {
    ...
    return(
        <div className="bio">
            ...
            <h2>I'll be <span style={{color: "#FFD271"}}>@Airbnb</span> soon and have learned tons from my previous experiences <span style={{color: "#FFD271"}}>@Reddit</span> and <a href={twitter_url} target="_blank" rel="noopener noreferrer"><span style={{color: "#FFD271", textDecoration: "underline #FFD271"}}>@Twitter.</span></a></h2>
            <h2>I'm in some awesome VC communities like the <a href={kp_url} target="_blank" rel="noopener noreferrer"><span style={{color: "#ffffff", textDecoration: "underline #FFD271"}}>Kleiner Perkins Fellowship</span></a> and <a href={wiress_url} target="_blank" rel="noopener noreferrer"><span style={{color: "#ffffff", textDecoration: "underline #FFD271"}}>The Wiress.</span></a></h2>
            <h2>I like to <a href={strava_run_url} target="_blank" rel="noopener noreferrer"><span style={{color: "#ffffff", textDecoration: "underline #ff073a"}}>run</span></a>, <a href={strava_bike_url} target="_blank" rel="noopener noreferrer"><span style={{color: "#ffffff", textDecoration: "underline #ff073a"}}>bike</span></a>, <span style={{color: "#ff073a"}}>take photos (see below)</span>, and <a href={photoshop_url} target="_blank" rel="noopener noreferrer"><span style={{color: "#ffffff", textDecoration: "underline #ff073a"}}>make my friends look epic</span></a>. Talk to me about climate tech, history and culture, and blockchain (or anything really)!</h2>
